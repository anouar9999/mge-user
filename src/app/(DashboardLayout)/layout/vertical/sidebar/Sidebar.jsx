          ...
          {menuItems.map((item) => {
            ...
            return (
              <Link
                href={item.href}
                key={item.id} 
                className={`w-full px-2 py-2 group relative transition-all duration-300 angular-cut
              ...
              >
                ...
                <div className="flex flex-col items-center  relative z-10">
                  ...
                  <span className={`text-xs font-custom tracking-widest transition-all mx-2 duration-300 text-center 
